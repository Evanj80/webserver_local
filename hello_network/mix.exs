defmodule HelloNetwork.MixProject do
  ...
  def application do
    appmodule= if(@target == "host") do
      HelloNetwork.HostApplication
      else
        HelloNetwork
    
    end
    [mod: {appmodule, []}, extra_applications: [:logger, :httpoison]]
  end
  ...
  defp extra_deps("host"), do: []

  defp extra_deps(target) do
    [
